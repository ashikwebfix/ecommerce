    ...
    <div className="container animate-fade-in" style={{ padding: '2rem 1.5rem' }}>
      ...
      {cartItems.length === 0 ? (
        <div className="glass" style={{ padding: '3rem', textAlign: 'center', borderRadius: '16px' }}>
          ...
          <Link href="/" className="btn btn-primary">শপিং করুন</Link>
        </div>
      ) : (
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
                  ...
                  <div>
                    <h3 style={{ fontSize: '1.25rem', fontWeight: '700', marginBottom: '0.25rem' }}>
                      <Link href={`/product/${item.slug || item.id}`} style={{ color: 'var(--text-primary)', textDecoration: 'none' }} className="hover-text-accent">
                        {item.name}
                      </Link>
                    </h3>
